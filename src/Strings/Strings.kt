...
fun main(args: Array<String>) {
    ...
    println( "I love ancient philiosophy" )

    // Use triple quote """ to go multi line. This also means that you can use double quote " freely in the string
    // This demonstrates template expression. Pretty neat huh. You can use $[] to show any arbitrary expression
    println("""My faorite quote is by '$plato1' although at ${plato1.length} characters long. it is not compact.
